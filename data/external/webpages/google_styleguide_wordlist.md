...
* [Periods and end punctuation](/style/periods)
...
* [Examples](/style/format-examples)
* [Figures and other images](/style/images)
* [Footnotes](/style/footnotes)
* [Headings and titles](/style/headings)
* [Key terms](/style/key-terms)
* [Letters as letters](/style/plural-single-letter)
* [Lists](/style/lists)
* [Notes and other notices](/style/notices)
...
* [Words as words](/style/words-as-words)
* Linking
* [Cross-references](/style/cross-references)
* [Headings as link targets](/style/headings-targets)
* [Link text](/style/link-text)
* [Links to other sites](/style/links-external)
* [URLs for images](/style/img-elements)
* Computer interfaces
* [API reference code comments](/style/api-reference-comments)
* [Code in text](/style/code-in-text)
* [Code samples](/style/code-samples)
* [Command-line syntax](/style/code-syntax)
* [Placeholder formatting](/style/placeholders)
* [UI elements and interaction](/style/ui-elements)
* HTML and CSS
* [HTML and semantic tagging](/style/semantic-tagging)
* [HTML formatting](/style/html-formatting)
* [Markdown versus HTML](/style/markdown)
* Names and naming
* [Example domains and names](/style/examples)
* [Filenames](/style/filenames)
* [Trademarks](/style/trademarks)
...
we [link](#we)
 ...
 Don't use *we* (or other second-person plural pronouns such as
...
workload [link](#workload)
 ...
 use the term *workload*, define your meaning on first use. For
 information about how to define or write around terms, see the
...
[![Google Developers](https://www.gstatic.com/devrel-devsite/prod/vd59826aff4c44c40ae6b66bb6749cdc41cdaad671ce8aa5208d5acf15cc7ec42/developers/images/lockup-google-for-developers.svg)](https://developers.google.com/)
